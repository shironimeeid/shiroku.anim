            ...
            {animeDetails ? (
                <>
                    <Helmet>
                        ...
                        <meta
                        name="description"
                        content="Tempat nonton anime subtitle Indonesia secara gratis di SHIRONIME.FUN tanpa gangguan banner iklan yang banyak dan mengganggu."
                        />
                        ...
                        <meta property="og:site_name" content="ShiroNime" />
                        ...
                        <meta name="twitter:description" content="Nonton Anime Online Sub Indo Gratis di SHIRONIME.FUN" />
                        <meta
                        name="twitter:image"
                        ...
                        <div className="px-16 grid relative lg:grid-cols-8 gap-4 place-content-center place-items-center bg-cover mb-10">
                            ...
                            <div className="anime-detail grid gap-5 md:grid-cols-5 md:mb-16 lg:col-span-6 py-16 place-items-center md:place-items-start relative">
                                ...
                                <div className="detail md:col-span-3 lg:col-span-4 text-center md:text-left">
                                    ...
                                    <p className="mt-5"><span className="font-semibold">SHIRONIME.FUN</span> merupakan situs tempat nonton anime <span className="font-semibold">{animeDetails.title}</span> subtitle indonesia secara gratis</p>
                                </div>
                            </div>
                            <AnimeDetail>
