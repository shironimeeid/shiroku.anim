        ...
        <>
            {(epsData && animeData && newsAnimeData && ongoingAnime.status === "success") ? (
                ...
                <Helmet>
                    ...
                    <meta
                    name="description"
                    content={`Nonton Anime ${epsData.title} - ShiroNime`}
                    />
                    <meta name="robots" content="index, follow" />
                    <meta
                    property="og:title"
                    content={`Nonton ${epsData.title} - ShiroNime`}
                    />
                    <meta
                    ...
                    <meta property="og:site_name" content="ShiroNime.FUN" />
                    <meta name="twitter:card" content="summary_large_image" />
                    <meta name="googlebot" content="index, follow" />
                    <meta name="twitter:title" content={`Nonton ${epsData.title} -ShiroNime`} />
                    <meta name="twitter:card" content="summary_large_image" />
                    ...
                    content="Nonton Anime Online Sub Indo Gratis diShiroNime.FUN"
                    />
                    <meta
                    name="twitter:image"
                    content="https://raw.githubusercontent.com/MastayY/kumanime/main/public/logo.png"
